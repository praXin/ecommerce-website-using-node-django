    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('color', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('cart_id', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
